        ...
        <div style="padding:50px" >
                <div class="card-fluid bg-white" >
                    <div class="row row-centered" style="padding:20px ">
                        ...
                        <div class="col-md-2">
                            <a href="sortmouse"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[1]->category_image}}"></a>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-md-2">
                            <a href="sortcpu"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[4]->category_image}}"></a>
                        </div>
                        <div class="col-md-2" >
                            <a href="sorthdmi"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;" src="upload/{{$categories[5]->category_image}}"></a>
                        </div>
                        <div class="col-md-2 " style="padding-top:20px">
                            <a href="sortpowercable"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[6]->category_image}}"></a>
                        </div>
                        <div class="col-md-2" style="padding-top:20px">
                            <a href="sortbattery"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[7]->category_image}}"></a>
                        </div>
                        <div class="col-sm-2" style="padding-top:20px">
                            <a href="sortmotherboard"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[8]->category_image}}"></a>
                        </div>
                        <div class="col-md-2" style="padding-top:20px">
                            <a href="sortprinter"><img class="rounded mx-auto d-block img-responsive " style="max-height: 50px; max-width: 100%;"  src="upload/{{$categories[9]->category_image}}"></a>
                        </div>
                        <div class="col-md-2" style="padding-top:20px">
